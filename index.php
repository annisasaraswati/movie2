        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav text-uppercase ml-auto">
                    ...
                    <li lass="nav-item">
                        <a class="nav-link js-scroll-trigger" href="category.php">Category</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container mt-5">
        ...
        <div id="about" class="mb-5">
            ...
            <div class="row text-justify">
                <p>Aktivitas Work From Home (WFH) yang dilakukan saat ini terkadang membuat jenuh, makanya tak heran banyak masyarakat mengisi kejenuhan mereka dengan melakukan berbagai cara mulai dari membaca buku hingga menonton film favorit. Nah, bagi Anda yang gemar menonton film, berikut ini adalah daftar website film streaming yang dapat menemani Anda disaat WFH. </p>
            </div>
        </div>
        <!-- End About -->
